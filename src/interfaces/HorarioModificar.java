...
public class HorarioModificar extends javax.swing.JDialog {
    int id;
    GestorBD bd;
    int horaIniDospuntos = 1, horaFinDospuntos = 1; 
    
    public HorarioModificar(int fila) {
        id = fila;
        int idHorario = fila;
        ...
        try {
            bd.getConnection();
            ResultSet rs = bd.consulta("SELECT * FROM `icba`.`horario` WHERE idHorario = "+idHorario);
            while (rs.next()){
            String horaInicial = rs.getString("horaInicio");
            horaInicial = horaInicial.substring(0, 5);
            jTextFieldHoraInicial.setText(horaInicial);
            //System.out.println(horaInicial);
            
            String horaFinal = rs.getString("horaFinal");
            horaFinal = horaFinal.substring(0, 5);
            jTextFieldHoraFinal.setText(horaFinal);
    ...
    public void guardarBaseDatos() throws HeadlessException {
        ...
        try {           
            ...
            if (repetido){
                JOptionPane.showMessageDialog(null,"Error al actualizar: El horario ya se encuentra registrado en la base de datos","Actualización de Horario",JOptionPane.INFORMATION_MESSAGE) ;
                jTextFieldHoraInicial.requestFocus();
            }
            else if (datosIngresados){
                JOptionPane.showMessageDialog(null,"Error al actualizar: No se han ingreasado todos los campos obligatorios","Actualización de Horario",JOptionPane.INFORMATION_MESSAGE) ;   
                jTextFieldHoraInicial.requestFocus();
            }   
            else if (horaCorrectaIni){
                JOptionPane.showMessageDialog(null,"Error al actualizar: No se ha ingresado la hora inicial en el formato adecuado (HH:MM)","Actualización de Horario",JOptionPane.INFORMATION_MESSAGE) ;   
                jTextFieldHoraInicial.requestFocus();
            } 
            else if (horaCorrectaFin){
                JOptionPane.showMessageDialog(null,"Error al actualizar: No se ha ingresado la hora final en el formato adecuado (HH:MM)","Actualización de Horario",JOptionPane.INFORMATION_MESSAGE) ;   
                jTextFieldHoraFinal.requestFocus();
            }
            else if (hora24Ini){
                JOptionPane.showMessageDialog(null,"Error al actualizar: La hora inicial debe encontrarse en el rango de 0 a 23","Actualización de Horario",JOptionPane.INFORMATION_MESSAGE) ;   
                jTextFieldHoraInicial.requestFocus();
            } 
            else if (hora24Fin){
                JOptionPane.showMessageDialog(null,"Error al actualizar: La hora final debe encontrarse en el rango de 0 a 23","Actualización de Horario",JOptionPane.INFORMATION_MESSAGE) ;   
                jTextFieldHoraFinal.requestFocus();
            }    
            else if (hora60Ini){
                JOptionPane.showMessageDialog(null,"Error al actualizar: Los minutos deben encontrarse en el rango de 00 a 59","Actualización de Horario",JOptionPane.INFORMATION_MESSAGE) ;   
                jTextFieldHoraInicial.requestFocus();
                ...
                JOptionPane.showMessageDialog(null,"Error al actualizar: La hora final debe ser posterior a la hora inicial","Actualización de Horario",JOptionPane.INFORMATION_MESSAGE) ;   
                jTextFieldHoraInicial.requestFocus();
                jTextFieldHoraInicial.selectAll();
            }             
            else{                
                String sentencia = "UPDATE `icba`.`horario` SET `dia` = '"+dia+"',"
                ...
                JOptionPane.showMessageDialog(null,"Los datos del horario fueron actualizados exitosamente","Actualización de Horario",JOptionPane.INFORMATION_MESSAGE) ;
                bd.cerrar();
                dispose();
                //}
                //else
            ...
            JOptionPane.showMessageDialog(null,"Hubo un error al intentar ingresar los datos","Actualización de Horario",JOptionPane.INFORMATION_MESSAGE) ;
            //System.out.println("Hubo un problema al intentar ingresar lo datos" + ex);
        }
        catch (NumberFormatException ex){
            if (horaCorrectaIni == true){
                JOptionPane.showMessageDialog(null,"Error al actualizar: La hora inicial debe tener el formato adecuado (HH:MM) y contener caracteres válidos","Actualización de Horario",JOptionPane.INFORMATION_MESSAGE);
                jTextFieldHoraInicial.requestFocus();
                jTextFieldHoraInicial.selectAll();
            }
            else{
                JOptionPane.showMessageDialog(null,"Error al actualizar: La hora final debe tener el formato adecuado (HH:MM) y contener caracteres válidos","Actualización de Horario",JOptionPane.INFORMATION_MESSAGE);
                jTextFieldHoraFinal.requestFocus();
                jTextFieldHoraFinal.selectAll();
            }
            //System.out.println("Hubo un problema al intentar ingresar lo datos" + ex);     
            ...
            if (horaCorrectaIni == true){
                JOptionPane.showMessageDialog(null,"Error al actualizar: La hora inicial debe tener el formato adecuado (HH:MM) y contener caracteres válidos","Registro de Horario",JOptionPane.INFORMATION_MESSAGE);
                jTextFieldHoraInicial.requestFocus();
                jTextFieldHoraInicial.selectAll();
            }
            else{
                JOptionPane.showMessageDialog(null,"Error al actualizar: La hora final debe tener el formato adecuado (HH:MM) y contener caracteres válidos","Registro de Horario",JOptionPane.INFORMATION_MESSAGE);
                jTextFieldHoraFinal.requestFocus();
                jTextFieldHoraFinal.selectAll();
            }
            //System.out.println("Hubo un problema al intentar ingresar lo datos" + ex);            
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jPanel1.add(jButtonGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 240, 170, 100));
        ...
        jPanel1.add(jButtonCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 240, 200, 100));
