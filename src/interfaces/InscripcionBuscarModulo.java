...
public final class InscripcionBuscarModulo extends javax.swing.JDialog {
    MiModelo modelo;
    int modulo;

    public InscripcionBuscarModulo() {
        inicializar();
    ...
    public void inicializar(){    
        ...
        jLabelNivelModulo = new JLabel();
        jTextFieldBuscar = new JTextField();
        jTableModulos = new JTable();
        ...
        jLabelNivelModulo.setBackground(new Color(255, 255, 255));
        jTextFieldBuscar.setBackground(new Color(255, 255, 255));
        jTableModulos.setBackground(new Color(255, 255, 255));
        ...
        jLabelNivelModulo.setFont(new Font("Harrington", 0, 24));
        jLabelNivelModulo.setText("Nivel");

        jTextFieldBuscar.setFont(new Font("Tahoma", 0, 18));

        //modelo = new DefaultTableModel();
        modelo = new MiModelo();
        jTableModulos = new JTable(modelo);   
        ...
        jPanelFondoLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelFondoLayout.createSequentialGroup()
                .addGap(79, 79, 79)
                .addComponent(jLabelNivelModulo)
                .addGap(36, 36, 36)
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jLabelNivelModulo = new javax.swing.JLabel();
        ...
        jLabelNivelModulo.setFont(new java.awt.Font("Harrington", 0, 24));
        jLabelNivelModulo.setText("Nivel");
        jPanelFondo.add(jLabelNivelModulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 40, -1, -1));
    ...
    public void buscarEstudiantes(String buscar){
        ...
        ResultSet rs = null;
        try {
            rs = bd.consulta("Select * From `icba`.`modulo` "
                    + "Where nivel like '%"+buscar+"%' "
    ...
    private void jButtonVerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVerActionPerformed
        int fila;
        fila = jTableModulos.getSelectedRow(); 
        ...
        if (fila == -1)
            ...
            modulo = Integer.parseInt(String.valueOf(jTableModulos.getValueAt(fila,0))); 
            dispose();
        }
    ...
    private javax.swing.JLabel jLabelNivelModulo;
