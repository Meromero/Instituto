...
public class AulaBuscarModificar extends javax.swing.JDialog {
    MiModelo modelo;
    
    public AulaBuscarModificar() {
        initComponents();
        buscarAula();
    }
    ...
    public void elegirAula(){
        ...
        if (fila == -1)
            ...
            AulaModificar modificar = new AulaModificar(aula);
    ...
    public void buscarAulas(String buscar){
        ...
        ResultSet rs = null;
        try {
            rs = bd.consulta("Select * From `icba`.`aula` Where (sigla like '%"+buscar+"%') AND estado = '1' Order By sigla"); 
