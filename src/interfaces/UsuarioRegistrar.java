...
public class UsuarioRegistrar extends javax.swing.JDialog {  
    GestorBD bd;
    ...
    public void guardarBaseDatos() throws HeadlessException {
        ...
        try {           
            ...
            if (repetido){
                JOptionPane.showMessageDialog(null,"Error al registrar: El usuario ya se encuentra registrado en la base de datos","Registro de Usuario",JOptionPane.INFORMATION_MESSAGE) ;
            }
            else if (incorrectoPass){
                JOptionPane.showMessageDialog(null,"Error al registrar: Las contraseñas introducidas no coiciden, vuelva a intentarlo","Registro de Usuario",JOptionPane.INFORMATION_MESSAGE) ;   
                jPasswordFieldPassword.requestFocus();
            }  
            else if (loginRepetido){
                JOptionPane.showMessageDialog(null,"Error al registrar: El login ya se encuentra registrado en la base de datos","Registro de Usuario",JOptionPane.INFORMATION_MESSAGE) ;   
                jTextFieldLogin.requestFocus();
            }
            else if (datosIngresados){
                JOptionPane.showMessageDialog(null,"Error al registrar: No se han ingreasado todos los campos obligatorios","Registro de Usuario",JOptionPane.INFORMATION_MESSAGE) ;   
                jTextFieldNombre.requestFocus();
            }   
           else if (camposLogin){
                JOptionPane.showMessageDialog(null,"Error al registrar: No se han ingreasado todos los campos de usuario (login y passwords)","Registro de Usuario",JOptionPane.INFORMATION_MESSAGE) ;   
                jTextFieldLogin.requestFocus();
            }  
            else{
                String sentencia = "INSERT INTO `icba`.`empleado` (nombre, apellidoPaterno, apellidoMaterno, "
                        + "ci, telefono, celular, direccion, "
                        + "email, fechaNacimiento, lugarNacimiento, "
                        + "tipoUsuario, login, password) "
    ...
    public int contarRegistros(){
        String sentencia = "Select Count(*) From `icba`.`empleado` ";
        ResultSet rs = null;
        try {
